...
func parseFlags() *config {
	...
	flag.StringVar(&cfg.eventhubName, "eventhub-name", os.Getenv("EVENTHUB_NAME"),
		"Name of Azure EventHub to send data to",
	)

	flag.StringVar(&cfg.eventhubNamespace, "eventhub-namespace", os.Getenv("EVENTHUB_NAMESPACE"),
		"Azure EventHub namespace to send data to",
	)

	flag.StringVar(&cfg.sasPolicyName, "eventhub-policy-name", os.Getenv("EVENTHUB_SAS_POLICY_NAME"),
		"Azure EventHub policy name",
	)

	flag.StringVar(&cfg.sasPolicyKey, "eventhub-policy-key", os.Getenv("EVENTHUB_SAS_POLICY_NAME"),
